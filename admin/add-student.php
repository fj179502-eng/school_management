...
<head>
  ...
  <title>SufiTech |Add Student </title>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
    ...
    <?php
     ...
     $q=mysqli_query($conn,"SELECT * FROM district WHERE is_active=1");
     $q1=mysqli_query($conn,"SELECT * FROM designation WHERE is_active=1");
    ?>
            ...
            <div class="card card-warning">
             <div class="card-header">
               ...
               <div class="card-body">
                 <form method="post">
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="sname" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                      <label style="float: left">Student Fathername</label><input type="text" required name="fname" class="form-control" placeholder="Enter..">
                    </div>
                    </div><!--col div-->
                   </div><!--row div-->
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="scast" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="scnic" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                   ...
                   <div class="row">
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="sphone" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="date" required="" name="birth" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                        <div class="col-md-6">
                        <?php
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="pcnic" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                      <label style="float: left">Parent Phone</label><input type="text" required name="pphone" class="form-control" placeholder="Enter..">
                    </div>
                    </div><!--col div-->
                   </div><!--row div-->
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="squalification" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                      <label style="float: left">Student Nation</label>
                       <input type="text" required name="nation" class="form-control" placeholder="Enter...">
                    </div>
                    </div><!--col div-->
                   </div><!--row div-->
                      ...
                      <div class="row">
                         <div class="col-md-6">
                      <div class="form-group">
                      <label style="float: left">Student Religion</label><input type="text" required name="religion" class="form-control" placeholder="Enter..">
                    </div>
                    </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                      <label style="float: left">Password</label><input type="text" required name="pass" class="form-control" placeholder="Enter..">
                    </div>
                    </div><!--col div-->
                  </div>
                      <div class="row">
                        ...
                        <input type="text"  required name="saddress" class="form-control"  placeholder="Enter...">
                      </div><!-- group div-->
                        </div>
                      </div><!--row div-->  
                ...
                <?php
                 if(isset($_POST['btn'])){
                  $a=mysqli_query($conn,"INSERT INTO `student`( `std_name`, `std_fname`, `std_cast`, `std_cnic`, `std_phone`, `std_gender`, `std_dob`, `class`, `std_district_id`, `std_designation_id`, `parent_cnic`, `parent_phone`, `std_qualification`, `std_nation`, `std_religion`, `std_address`,`password`) VALUES ('".$_POST['sname']."','".$_POST['fname']."','".$_POST['scast']."','".$_POST['scnic']."','".$_POST['sphone']."','".$_POST['sgender']."','".$_POST['birth']."','".$_POST['class1']."','".$_POST['district1']."','".$_POST['designation1']."','".$_POST['pcnic']."','".$_POST['pphone']."','".$_POST['squalification']."','".$_POST['nation']."','".$_POST['religion']."','".$_POST['saddress']."','".$_POST['pass']."')");
                  if($a>0){
                    ?>
