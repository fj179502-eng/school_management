...
<head>
  ...
  <title>SufiTech |View Class </title>
                     ...
                     if($row>0){
                      ...
                      ?> 
                        ...
                        <tr>
                          ...
                          <td><a href="update-class.php?clid=<?php echo $row['class_id']?>" class="btn btn-success">Update</a>
                            <a href="delete-class.php?clid=<?php echo $row['class_id']?>" class="btn btn-danger">Delete</a></td>
                        </tr>
