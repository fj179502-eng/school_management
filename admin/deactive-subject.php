...
<head>
  ...
  <title>SufiTech |Deactive Suject </title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="dashboaed.php" class="brand-link">
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                   <?php
                 $q=mysqli_query($conn,"SELECT * FROM subject WHERE is_active=0");
                 $s=0;
                 while($row=mysqli_fetch_array($q)){
                  ...
                  <tr>
                    ...
                    <td><a href="active-subject.php?subid=<?php echo $row['sub_id']?>" class="btn btn-primary">Active</a>
