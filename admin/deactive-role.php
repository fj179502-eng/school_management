...
<head>
  ...
  <title>SufiTech |Deactive Role </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                     $q=mysqli_query($conn,"SELECT * FROM user_role WHERE is_active=0");
                     $s=0;
                     while($row=mysqli_fetch_array($q)){ 
                      $s++;
                       ...
                       <tr>
                         ...
                         <td><a href="active-role.php?rid=<?php echo $row['role_id']?>" class="btn btn-primary">Active</a>
                         </td>
                       </tr> 
