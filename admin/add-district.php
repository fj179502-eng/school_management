...
<head>
  ...
  <title>SufiTech |Add District </title>
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                        ...
                        <select id="district1" name="district1" class="form-control">
                          ...
                          <option value="Noshoroferoze">Naushahro feroze</option>
                          <option value="Qamber">Qamber</option>
                          <option value="Sanghar">Sanghar</option>
                          <option value="SBA">SBA</option>
                          <option value="Sujawal">Sujawal</option>
                          <option value="Sukkur">Sukkar</option>
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Submit" class="btn btn-primary"></div>
                  ...
                  <?php
            if(isset($_POST['btn'])){
           $q=mysqli_query($conn,"INSERT INTO `district`(`district_name`) VALUES ('".$_POST['district1']."')");
           if($q>0){
            ?>
