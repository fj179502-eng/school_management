...
<head>
  ...
  <title>SufiTech |View Employee </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $q=mysqli_query($conn,"SELECT * FROM employee WHERE is_active=1");
                    $s=0;
                    while($row=mysqli_fetch_array($q)){ 
                     $s++;
                     if($row>0){
                      $q1=mysqli_query($conn,"SELECT * FROM district WHERE district_id='".$row['emp_district_id']."' and is_active=1");
                      $row1=mysqli_fetch_array($q1);
                      if($row1>0){
                        $q2=mysqli_query($conn,"SELECT * FROM designation WHERE designation_id='".$row['emp_designation_id']."' and is_active=1");
                     ...
                     <tr>
                       ...
                       <td><a href="employee-profile.php?empid=<?php echo $row['emp_id']?>" class="btn btn-primary">View</a>
                        <a href="update-employee.php?empid=<?php echo $row['emp_id']?>" class="btn btn-success">Update</a>
                        <a href="delete-employee.php?empid=<?php echo $row['emp_id']?>" class="btn btn-danger" >Delete</a></td>
                     </tr>
