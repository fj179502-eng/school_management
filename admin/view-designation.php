...
<head>
  ...
  <title>SufiTech |View Designation </title>
  ...
  <div class="content-wrapper"  >
    ...
    <div class="content-header" >
      <div class="container-fluid" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Designation Form</h1>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                     $q=mysqli_query($conn,"SELECT * FROM designation WHERE is_active=1");
                     $s=0;
                     while($row=mysqli_fetch_array($q)){ 
                      $s++;
                       ...
                       <tr>
                         ...
                         <td><a href="update-designation.php?desid=<?php echo $row['designation_id']?>" class="btn btn-success">Update</a>
                          <a href="delete-designation.php?desid=<?php echo $row['designation_id']?>" class="btn btn-danger">Delete</a></td>
                       </tr> 
