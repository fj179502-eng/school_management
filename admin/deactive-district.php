...
<head>
  ...
  <title>SufiTech |Deactive District </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                     $q=mysqli_query($conn,"SELECT * FROM district WHERE is_active=0");
                     $s=0;
                     while($row=mysqli_fetch_array($q)){ 
                      $s++;
                       ...
                       <tr>
                         ...
                         <td><a href="active-district.php?did=<?php echo $row['district_id']?>" class="btn btn-primary">Active</a>
                          </td>
                       </tr> 
