...
<head>
  ...
  <title>SufiTech |Deactive Class </title>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
    ...
    <?php
     ...
     $cid=$_GET['clid'];
     $q=mysqli_query($conn,"SELECT * FROM class WHERE class_id='".$cid."' and is_active=1");
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="text" required name="classname" class="form-control" value="<?=$row['class_name']?>">     
                       </div><!--form group-->
                     </div><!--col div-->  
                   </div><!--row div--> 
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Update" class="btn btn-success"></div>
                  ...
                  <?php
                   if(isset($_POST['btn'])){
                    $c=mysqli_query($conn,"UPDATE `class` SET `class_name`='".$_POST['classname']."' WHERE class_id='".$cid."' and is_active=1");
                    if($c>0){
                      ?>
                      <script type="text/javascript">
                        window.location="view-class.php";
                      </script>
                      <?php
                    }
                   }
