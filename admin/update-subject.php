...
<head>
  ...
  <title>SufiTech |Update Subject </title>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
    ...
    <?php
     ...
     $sbid=$_GET['subid'];
     $q1=mysqli_query($conn,"SELECT * FROM subject WHERE sub_id='".$sbid."' and is_active=1");
            ...
            <div class="card card-warning">
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         <label style="float: left">Add Subject</label>
                         <input type="text" required name="subject1" class="form-control" value="<?=$row1['subject_name']?>">     
                       </div><!--form group-->
                     </div><!--col div--> 
                     ...
                     <div class="col-md-12">
                      <?php
                      $cid=$row1['class_id'];
                      $q2=mysqli_query($conn,"SELECT * FROM class WHERE class_id='".$cid."' and is_active=1");
                      $row2=mysqli_fetch_array($q2);
                      $q3=mysqli_query($conn,"SELECT * FROM class WHERE is_active=1");
                      ?>
                       <div class="form-group">
                         <label style="float: left">Class Name</label>
                         <select id="class1" name="class1" class="form-control">
                        <option selected value="<?php echo $row2['class_id']?>"> <?php echo $row2['class_name']?></option>
                         <option>Select</option>
                         <?php
                         while($row3=mysqli_fetch_array($q3)){ ?>
                         <option value="<?php echo $row3['class_id']?>"><?php echo $row3['class_name']?></option>
                          <?php }
                         ?>
                         </select>
                       </div>
                ...
                <?php
                if(isset($_POST['btn'])){
                $q=mysqli_query($conn,"UPDATE subject SET subject_name='".$_POST['subject1']."',class_id='".$_POST['class1']."' WHERE sub_id='".$sbid."' and is_active=1");
                if($q>0){
                  ?>
