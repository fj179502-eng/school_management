...
<head>
  ...
  <title>SufiTech |View Student </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                   ...
                   <?php
                   $q=mysqli_query($conn,"SELECT * FROM student WHERE is_active=1");
                   $s=0;
                   while($row=mysqli_fetch_array($q)){ 
                    ...
                    <tr>
                     ...
                     <td><a href="student-profile.php?stdid=<?php echo $row['std_id']?>" class="btn btn-primary">View</a>
                      <a href="update-student.php?stdid=<?php echo $row['std_id']?>" class="btn btn-success">Update</a>
                      <a href="delete-student.php?stdid=<?php echo $row['std_id']?>" class="btn btn-danger">Delete</a></td>  
                    </tr>
