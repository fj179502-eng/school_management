...
<head>
  ...
  <title>SufiTech |Add Class </title>
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="text" required name="classname" class="form-control" placeholder="Enter...">     
                       </div><!--form group-->
                     </div><!--col div--> 
                   </div><!--row div--> 
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Submit" class="btn btn-primary"></div>
                  ...
                  <?php
                  if(isset($_POST['btn'])){
                 $a=mysqli_query($conn,"INSERT INTO `class`( `class_name`) VALUES ('".$_POST['classname']."')");
                 if($a>0){
                  ?>
