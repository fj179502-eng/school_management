...
<head>
  ...
  <title>SufiTech |Add Timetable </title>
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Submit" class="btn btn-primary"></div>
                  ...
                  <?php
                  if(isset($_POST['btn'])){
                   $a=mysqli_query($conn,"INSERT INTO bridge (`class_id`,`teacher_id`,`subject_id`,`is_class_teacher`) Values('".$_POST['class1']."','".$_POST['teacher1']."','".$_POST['subject1']."','".$_POST['classteacher']."')");
                   if($a>0){
                     ?>
