...
<head>
  ...
  <title>SufiTech |Add Employee </title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="deactive-timestable.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
               ...
               <div class="card-body">
                 <form method="post">
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="ename" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                      <label style="float: left">Employee Fathername</label><input type="text" required name="fname" class="form-control" placeholder="Enter..">
                    </div>
                    </div><!--col div-->
                   </div><!--row div-->
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="ecast" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="ecnic" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                     <div class="form-group">
                    ...
                    <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="ephone" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                     <div class="form-group">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6">
                      <div class="form-group">
                      <label style="float: left">Date Of Job</label><input type="date" required name="job" class="form-control" placeholder="Enter..">
                    </div>
                    </div><!--col div-->
                   </div><!--row div-->
                   ...
                   <div class="row">
                     <div class="col-md-6">
                       <div class="form-group">
                         ...
                         <input type="text" required="" name="equalification" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     <div class="col-md-6">
                      <div class="form-group">
                   ...
                   <div class="form-group">
                        ...
                        <textarea required name="eaddress" class="form-control" rows="3" placeholder="Enter..."></textarea>
                      </div><!-- group div-->
                 ...
                 <?php
                if(isset($_POST['btn'])){
                  $q2=mysqli_query($conn,"INSERT INTO `employee`( `emp_name`, `emp_fname`, `emp_cast`, `emp_gender`, `emp_cnic`, `emp_district_id`, `emp_phone`, `emp_designation_id`, `emp_dob`, `emp_doj`, `emp_qualification`, `is_class_teacher`, `emp_address`) VALUES ('".$_POST['ename']."','".$_POST['fname']."','".$_POST['ecast']."','".$_POST['egender']."','".$_POST['ecnic']."','".$_POST['district1']."','".$_POST['ephone']."','".$_POST['designation1']."','".$_POST['birth']."','".$_POST['job']."','".$_POST['equalification']."','".$_POST['classteacher']."','".$_POST['eaddress']."')");
                  if($q2>0){
                  ?>
