...
<head>
  ...
  <title>SufiTech |Update Designation </title>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
    ...
    <?php
     ...
     $did=$_GET['desid'];
     $q=mysqli_query($conn,"SELECT * FROM designation WHERE designation_id='".$did."' and is_active=1");
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                        <label style="float: left">Designation Name</label>
                        <input type="text" name="designation1" class="form-control" value="<?=$row['designation_name']?>">
                       </div><!--form group-->
                     </div><!--col div-->
                   </div><!--row div-->
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Update" class="btn btn-success"></div>
                  ...
                  <?php
            if(isset($_POST['btn'])){
           $q=mysqli_query($conn,"UPDATE `designation` SET`designation_name`='".$_POST['designation1']."' WHERE designation_id='".$did."' and is_active=1");
           if($q>0){
            ?>
            <script type="text/javascript">
              window.location="view-designation.php";
            </script>
            <?php
