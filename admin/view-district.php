...
<head>
  ...
  <title>SufiTech |View District </title>
                     ...
                     while($row=mysqli_fetch_array($q)){ 
                      $s++;
                       ...
                       <tr>
                         ...
                         <td><a href="update-district.php?did=<?php echo $row['district_id']?>" class="btn btn-success">Update</a>
                          <a href="delete-district.php?did=<?php echo $row['district_id']?>" class="btn btn-danger">Delete</a></td>
                       </tr> 
