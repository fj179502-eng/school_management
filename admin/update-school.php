...
<head>
  ...
  <title>SufiTech |Update School </title>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
    ...
    <?php
     ...
     $scid=$_GET['sid'];
     $q1=mysqli_query($conn,"SELECT * FROM school WHERE school_id='".$scid."' and is_active=1");
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         <label style="float: left">Add School</label>
                         <input type="text" required name="schoolname" class="form-control" value="<?=$row1['school_name']?>">
                       </div><!--form group-->
                     </div><!--col div-->
                   </div><!--row div-->
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Update" class="btn btn-success"></div>
                  ...
                  <?php
            if(isset($_POST['btn'])){
           $q=mysqli_query($conn,"UPDATE `school` SET `school_name`='".$_POST['schoolname']."' WHERE school_id='".$scid."' and is_active=1 ");
           if($q>0){
           ?>
           <script type="text/javascript">
             window.location="view-school.php"
           </script>
           <?php
            }
           }
