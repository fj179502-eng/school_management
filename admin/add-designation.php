...
<head>
  ...
  <title>SufiTech |Add Designation </title>
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                        ...
                        <input type="text" name="designation1" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                   </div><!--row div-->
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Submit" class="btn btn-primary"></div>
                  ...
                  <?php
            if(isset($_POST['btn'])){
           $q=mysqli_query($conn,"INSERT INTO `designation`(`disgnation_name`) VALUES ('".$_POST['designation1']."')");
           if($q>0){
            ?>
