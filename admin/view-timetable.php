...
<head>
  ...
  <title>SufiTech |View Timetable </title>
  ...
  <div class="content-wrapper"  >
    ...
    <div class="content-header" >
      <div class="container-fluid" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Timetable Form</h1>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                    $q=mysqli_query($conn,"SELECT * FROM bridge WHERE is_active=1");
                    $s=0;
                    while($row=mysqli_fetch_array($q)){
                      ...
                      if($row>0){
                        ...
                        if($row1>0){
                          $q2=mysqli_query($conn,"SELECT * FROM employee WHERE emp_id='".$row['teacher_id']."' and is_active=1");
                          $row2=mysqli_fetch_array($q2);
                          if($row2>0){
                            $q3=mysqli_query($conn,"SELECT * FROM subject WHERE sub_id='".$row['subject_id']."' and is_active=1");
                            ...
                            if($row3>0){
                              ...
                              <tr>
                                ...
                                <td><a href="update-timetable.php?tid=<?php echo $row['b_id']?>" class="btn btn-success">Update</a> 
                                  <a href="delete-timetable.php?tid=<?php echo $row['b_id']?>" class="btn btn-danger">Delete</a></td>
                              </tr>
                              <?php 
                            }
                          }
