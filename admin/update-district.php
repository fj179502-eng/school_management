...
<head>
  ...
  <title>SufiTech |Update District </title>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
    ...
    <?php
     ...
     $diid=$_GET['did'];
     $q=mysqli_query($conn,"SELECT * FROM district WHERE district_id='".$diid."' and is_active=1");
           ...
           <div class="col-md-6">
            <div class="card card-warning">
             <div class="card-header">
               <h2 class="card-title">Dsitrict</h2>
             </div><!--card header-->
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="text" required name="district1" class="form-control" value="<?=$row['district_name']?>">
                       </div><!--form group-->
                     </div><!--col div-->
                   </div><!--row div-->
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Update" class="btn btn-success"></div>
                  ...
                  <?php
            if(isset($_POST['btn'])){
           $q1=mysqli_query($conn,"Update `district` SET district_name='".$_POST['district1']."' WHERE district_id='".$diid."' and is_active=1");
           if($q1>0){
            ?>
            <script type="text/javascript">
              window.location="view-district.php";
            </script>
            <?php
            }
           }
