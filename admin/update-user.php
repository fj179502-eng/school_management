...
<head>
  ...
  <title>SufiTech |Upate User Login </title>
  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
    ...
    <?php
     ...
     $uid=$_GET['userid'];
     $q1=mysqli_query($conn,"SELECT * FROM user_login WHERE user_id='".$uid."' and is_active=1");
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                 <form method="post">
                   <div class="row">
                      <div class="col-md-12">
                        <?php
                        $eid=$row1['emp_id'];
                        $q2=mysqli_query($conn,"SELECT * FROM employee WHERE emp_id='".$eid."' and is_active=1");
                        $row2=mysqli_fetch_array($q2);
                     $q3=mysqli_query($conn,"SELECT * FROM employee WHERE is_active=1");
                        ?>
                       <div class="form-group">
                         <label style="float: left">Employee</label>
                         <select id="employee" name="employee" class="form-control">
                          <option selected value="<?php echo $row2['emp_id']?>"><?php echo $row2['emp_name']?></option>
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="email" required name="email1" class="form-control" value="<?=$row1['email']?>">
                       </div><!--form group-->
                     </div><!--col div-->
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="password" required name="pass" class="form-control" value="<?=$row1['password']?>">
                       </div><!--form group-->
                     </div><!--col div-->
                   </div><!--row div-->
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Submit" class="btn btn-primary"></div>
                   ...
                   <?php
                  if(isset($_POST['btn'])){
                    $q=mysqli_query($conn,"UPDATE `user_login` SET `emp_id`='".$_POST['employee']."',`email`='".$_POST['email1']."',`password`='".$_POST['pass']."' WHERE user_id='".$uid."' and is_active=1");
                    if($q>0){
                      ?>
