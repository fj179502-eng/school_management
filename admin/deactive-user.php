...
<head>
  ...
  <title>SufiTech |Deactive User Login </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                     $q=mysqli_query($conn,"SELECT * FROM user_login WHERE is_active=0");
                     $s=0;
                     while($row=mysqli_fetch_array($q)){ 
                      ...
                      <tr>
                        ...
                        <td><a href="active-user.php?userid=<?php echo $row['user_id']?>" class="btn btn-primary">Active</a></td>
                      </tr>
