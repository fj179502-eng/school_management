...
<head>
  ...
  <title>SufiTech |Teacher Account </title>
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable" >
            ...
            <div class="card" >
              ...
              <div class="card-header">
                <h2 class="card-title">Teacher Account</h2>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    while($row=mysqli_fetch_array($q)){
                      $s++;
                    if($row>0){
                      $q1=mysqli_query($conn,"SELECT * FROM employee WHERE emp_id='".$row['teacher_id']."' and is_active=1");
                      $row1=mysqli_fetch_array($q1);
                      if($row1>0){
                        $q2=mysqli_query($conn,"SELECT * FROM subject WHERE sub_id='".$row['subject_id']."' and is_active=1 ");
                        $row2=mysqli_fetch_array($q2);
                        if($row2>0){
                          $q3=mysqli_query($conn,"SELECT * FROM class WHERE class_id='".$row['class_id']."' and is_active=1");
