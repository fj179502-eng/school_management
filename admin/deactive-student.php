...
<head>
  ...
  <title>SufiTech |Deactive Student </title>
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     ...
                     <?php
                    $q=mysqli_query($conn,"SELECT * FROM student WHERE is_active=0");
                    $s=0;
                    while($row=mysqli_fetch_array($q)){ 
                     ...
                     if($row>0){
                      ...
                      <tr>
                        ...
                        <td><a href="active-student.php?stdid=<?php echo $row['std_id']?>" class="btn btn-primary">Active</a></td>
                      </tr> 
