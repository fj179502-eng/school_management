...
<head>
  ...
  <title>SufiTech |Deactive Designation </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                     $q=mysqli_query($conn,"SELECT * FROM designation WHERE is_active=0");
                     $s=0;
                     while($row=mysqli_fetch_array($q)){ 
                      $s++;
                       ...
                       <tr>
                         ...
                         <td><a href="active-designation.php?desid=<?php echo $row['designation_id']?>" class="btn btn-primary">Active</a></td>
                       </tr> 
