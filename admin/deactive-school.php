...
<head>
  ...
  <title>SufiTech |Deactive School </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                     $q=mysqli_query($conn,"SELECT * FROM school WHERE is_active=0");
                     $s=0;
                     while($row=mysqli_fetch_array($q)){ 
                      $s++;
                       ...
                       <tr>
                         ...
                         <td><a href="active-school.php?sid=<?php echo $row['school_id']?>" class="btn btn-primary">Active</a>
                          </td>
                       </tr> 
