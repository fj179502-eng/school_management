...
<head>
  ...
  <title>SufiTech |View Subject </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                   <?php
                 $q=mysqli_query($conn,"SELECT * FROM subject WHERE is_active=1");
                 $s=0;
                 while($row=mysqli_fetch_array($q)){
                  ...
                  <tr>
                    ...
                    <td><a href="update-subject.php?subid=<?php echo $row['sub_id']?>" class="btn btn-success">Update</a>
                    <a href="delete-subject.php?subid=<?php echo $row['sub_id']?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php }  }
                  }
