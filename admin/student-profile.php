            ...
            <div class="card card-warning" style="border-radius: 20px;box-shadow: rgba(0, 0 ,1.5)0px 0px 10px;">
             <div class="card-header">
               ...
               <div class="card-body" style="padding: 20px">
                 ...
                 $q1=mysqli_query($conn,"SELECT * FROM district WHERE district_id='".$row['std_district_id']."' and is_active=1");
                 $row1=mysqli_fetch_array($q1);

                 $q2=mysqli_query($conn,"SELECT * FROM designation WHERE designation_id='".$row['std_designation_id']."' and is_active=1");
                 $row2=mysqli_fetch_array($q2);
                 $q3=mysqli_query($conn,"SELECT * FROM class WHERE class_id='".$row['class']."' and is_active=1");
                 ...
                 <table class="table">
                   ...
                   <tr>
                     <td ><label style="float: left">Std Fathername:</label></td>
                     <td><?php echo $row['std_fname']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Student Cast:</label></td>
                     <td><?php echo $row['std_cast']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Student CNIC:</label></td>
                     <td><?php echo $row['std_cnic']?></td>
                   </tr>
                   ...
                   <tr>
                     <td><label style="float: left">Student Gender:</label></td>
                   ...
                   <tr>
                     <td><label style="float: left">Class:</label></td>
                     <td><?php echo $row3['class_name']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Std District:</label></td>
                     <td><?php echo $row1['district_name']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Designation:</lable></td>
                      <td><?php echo $row2['designation_name']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Parent CNIC:</lable></td>
                      <td><?php echo $row['parent_cnic']?></td>
                      </tr>

                      <tr>
                        <td><label style="float: left">Parent Phone:</label></td>
                         <td><?php echo $row['parent_phone']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Std Qualification:</lable></td>
                      <td><?php echo $row['std_qualification']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Student Nation:</label></td>
                     <td><?php echo $row['std_nation']?></td>
                   </tr>
                   <tr>
                     <td><label style="float: left">Student Religion:</label></td>
                     <td><?php echo $row['std_religion']?></td>
                   </tr>

                   <tr>
                     <td><label style="float: left">Student Address:</label></td>
