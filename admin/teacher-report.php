...
<head>
  ...
  <title>SufiTech |Teacher Report </title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="dashboarb.php" class="brand-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header" >
      <div class="container-fluid" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Over All Report</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable" >
            ...
            <div class="card" >
              ...
              <div class="card-header">
                <h2 class="card-title">Teacher Report</h2>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               ...
               <form method="post">
                    <?php
                  $e=mysqli_query($conn,"SELECT * FROM employee WHERE is_active=1 ");
                     ?>
                   <div class="col-md-4"  style="border:solid;border-radius: 15px;padding:10px">
                     <label>Teacher</label>
                     <select id="teacher1" required name="teacher1" class="form-control">
                       <option>Select</option>
                       <?php
                       while($rowe=mysqli_fetch_array($e)){
                       if($rowe['emp_designation_id']==2){
                        ?> 
                       <option value="<?php echo $rowe['emp_id']?>"><?php echo $rowe['emp_name']?></option>
                       <?php } }
                       ?>
                     </select><br/>
                     <div align="center"><input type="submit" style="width: 120px"  name="btn" value="Search" class="btn btn-success"></div>
                   </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>Teacher</th>
                        <th>Subject</th>
                        <th>Mid Obtain Marks</th>
                        <th>Mid Total Marks</th>
                        <th>Final Obtain Marks</th>
                        <th>Final Total Marks</th>
                        <th>Total Marks</th>
                        <th>Percentage</th>
                      </tr>
                    </thead>
                ...
                <?php
                if(isset($_POST['btn'])){
              $q=mysqli_query($conn,"SELECT * FROM mid_result WHERE teacher_id='".$_POST['teacher1']."' and  is_active=1");
              $s=0;
              while($row=mysqli_fetch_array($q)){ 
             $s++;
             if($row>0){
              # $q5=mysqli_query($conn,"SELECT * FROM final_result WHERE is_active=1");
                ...
                if($row1>0){
                 ...
                 if($row2>0){
                  ...
                  if($row3>0){
                    ...
                    $row5=mysqli_fetch_array($q5);
             if($row5>0){
                //Total Marks Mid and Final...
              $result= $row['total_marks']+ $row5['total_marks'];
               //Total Percentage... 
              $percentage=($row['obtain_marks']+ $row5['obtain_marks'])*$result/100;  
                ?>
                   ...
                   <td><?php echo $row2['class_name']?></td>
                    <td><?php echo $row3['emp_name']?></td>
                     ...
                     <!--Mid Marks-->
                      ...
                      <!--Final Marks-->
                      <td><?php echo $row5['obtain_marks']?></td>
                       <td><?php echo $row5['total_marks']?></td>
