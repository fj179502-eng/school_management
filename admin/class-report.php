...
<head>
  ...
  <title>SufiTech |Class Report </title>
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable" >
            ...
            <div class="card" >
              ...
              <div class="card-header">
                <h2 class="card-title">Class Report</h2>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               ...
               <form method="post">
                    <?php
                  $a=mysqli_query($conn,"SELECT * FROM class WHERE is_active=1 ");
                     ?>
                   <div class="col-md-4"  style="border:solid;border-radius: 15px;padding:10px">
                     <label>Class</label>
                     <select id="class1" required name="class1" class="form-control">
                       <option>Select</option>
                       <?php
                       while($rowc=mysqli_fetch_array($a)){ ?> 
                ...
                <?php
                if(isset($_POST['btn'])){
              $q=mysqli_query($conn,"SELECT * FROM mid_result WHERE class_id='".$_POST['class1']."' and is_active=1");
              $s=0;
