...
<head>
  ...
  <title>SufiTech |View User Login </title>
  ...
  <div class="content-wrapper"  >
    ...
    <div class="content-header" >
      <div class="container-fluid" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">User Login Form</h1>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                     $q=mysqli_query($conn,"SELECT * FROM user_login WHERE is_active=1");
                     $s=0;
                     while($row=mysqli_fetch_array($q)){ 
                      $s++;
                      if($row>0){
                        $q1=mysqli_query($conn,"SELECT * FROM employee WHERE emp_id='".$row['emp_id']."' and is_active=1");
                      ...
                      <tr>
                        ...
                        <td><a href="update-user.php?userid=<?php echo $row['user_id']?>" class="btn btn-success">Update</a>
                          <a href="delete-user.php?userid=<?php echo $row['user_id']?>" class="btn btn-danger">Delete</a></td>
                      </tr>
