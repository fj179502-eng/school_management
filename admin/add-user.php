...
<head>
  ...
  <title>SufiTech |Add User Login </title>
             ...
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="email" required name="email1" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                     ...
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="password" required name="pass" class="form-control" placeholder="Enter...">
                       </div><!--form group-->
                     </div><!--col div-->
                   </div><!--row div-->
                 ...
                 <div align="center"><input type="submit" style="width: 150px" name="btn" value="Submit" class="btn btn-primary"></div>
                   ...
                   <?php
                  if(isset($_POST['btn'])){
                    $q=mysqli_query($conn,"INSERT INTO `user_login`( `emp_id`, `email`, `password` ) VALUES ('".$_POST['employee']."','".$_POST['email1']."','".$_POST['pass']."')");
                    if($q>0){
                      ?>
