...
<head>
  ...
  <title>SufiTech |Add Subject </title>
           ...
           <div class="col-md-6">
            <div class="card card-warning">
             <div class="card-header">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group">
                         ...
                         <input type="text" required name="subject1" class="form-control" placeholder="Enter...">     
                       </div><!--form group-->
                     </div><!--col div--> 
               ...
               $q1=mysqli_query($conn,"SELECT * FROM subject WHERE subject_name='".$subject."' and is_active=1");
               $row1=mysqli_fetch_array($q1);
               if($row1>0){
                echo "<h3>The Subject is Already Exit</h3>";
                  }
                  else{
                    $q2=mysqli_query($conn,"INSERT INTO `subject`(`subject_name`, `class_id`) VALUES ('".$_POST['subject1']."','".$_POST['class1']."')");
                    if($q2>0){
                      ?>
