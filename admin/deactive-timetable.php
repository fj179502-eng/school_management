...
<head>
  ...
  <title>SufiTech |Deactive Timetable </title>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                    $q=mysqli_query($conn,"SELECT * FROM bridge WHERE is_active=0");
                    $s=0;
                          ...
                          if($row2>0){
                            ...
                            if($row3>0){
                              ...
                              <tr>
                                ...
                                <td><a href="active-timetable.php?tid=<?php echo $row['b_id']?>" class="btn btn-primary">Active</a> 
                                  </td>
                              </tr>
                              <?php 
                            }
