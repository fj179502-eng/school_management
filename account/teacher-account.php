              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $q=mysqli_query($conn,"SELECT * FROM bridge WHERE teacher_id='".$_SESSION['userid']."' and is_active=1");
                    $s=0;
                    while($row=mysqli_fetch_array($q)){
                      $s++;
                      if($row>0){
                      $q1=mysqli_query($conn,"SELECT * FROM subject WHERE sub_id='".$row['subject_id']."' and is_active=1");
                      ...
                      if($row1>0){
                        ...
                        if($row2>0){
                          ...
                          <tr>
                            ...
                            <td><a href="student-class-account.php?bid=<?php echo $row['b_id']?>" class="btn btn-primary">Add</a></td>
                          </tr>
                          <?php
                        }
                      }
