...
<head>
  ...
  <title>SufiTech |Mid Result </title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-3">
          <div class="col-sm-6">
            <h1><?php echo $rows['std_name']?> Mid Result</h1>
          </div><!--col div-->
        </div><!--col div-->
      </div><!--container fluid-->
            ...
            <div class="card card-warning">
             <div class="card-header">
               ...
               <div class="card-body">
                   ...
                   <div class="row">       
                       <div class="col-md-12">
                         <div class="form-group">
                           ...
                           <input type="text" required name="obmarks" class="form-control" placeholder="Enter..." >
                         </div><!--from group-->
                       </div><!--col div-->
                ...
                $a=mysqli_query($conn,"INSERT INTO `mid_result`( `student_id`, `class_id`, `teacher_id`, `subject_id`, `obtain_marks`, `total_marks`, `exam_year`) VALUES ('".$_GET['std']."','".$row['class_id']."','".$row['teacher_id']."','".$row['subject_id']."','".$_POST['obmarks']."','".$_POST['totalmarks']."','".$_POST['year1']."')");
                if($a>0){
                  echo "<h3>Your Message Is  Successfully Submit</h3>";
                }
                else{
                  echo "<h3>The Message is not Submit</h3>";
                }
              }
