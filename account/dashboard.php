...
<head>
  ...
  <title>SufiTech |Account Dashboard</title>
  ...
  include('dbconection.php');
   $a=mysqli_query($conn,"SELECT * FROM employee WHERE emp_id='".$_SESSION['userid']."' and is_active=1");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Welcome To Teacher Account</h1>
          </div><!-- /.col -->
