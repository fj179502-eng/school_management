...
<head>
  ...
  <title>SufiTech |View Final Result </title>
  ...
  <div class="content-wrapper"  >
    ...
    <div class="content-header" >
      <div class="container-fluid" >
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Fianl Result Form</h1>
              ...
              <div class="card-body">
               ...
               <form method="post">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                  $q=mysqli_query($conn,"SELECT * FROM final_result WHERE is_active=1");
                  $s=0;
                  while($row=mysqli_fetch_array($q)){ 
                   ...
                   if($row>0){
                    ...
                    if($row2>0){
                      ...
                      if($row3>0){
                        $q4=mysqli_query($conn,"SELECT * FROM class WHERE class_id='".$row['class_id']."' and is_active=1");
