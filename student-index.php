            ...
            <div class="form-block" style="border-radius: 15px; border: solid #305D7D">
              ...
              <form  method="post">
                <div class="form-group first">
                  <label for="username"><b>CNIC(WithOut Dash)</b></label>
                  <input type="number" name="cnic1" required class="form-control" style="border:solid 1.5px; border-color:#fb771a " placeholder="Your CNIC" id="cnic1">
                </div>
              ...
              <?php
                  if(isset($_POST['btn'])){
                  $q=mysqli_query($conn,"SELECT * FROM student WHERE std_cnic='".$_POST['cnic1']."' and password='".$_POST['pass']."' and is_active=1");
